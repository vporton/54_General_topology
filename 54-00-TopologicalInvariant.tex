...
\usepackage{pmmeta}
\pmcanonicalname{TopologicalInvariant}
\pmcreated{2013-03-22 13:42:07}
\pmmodified{2013-03-22 13:42:07}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{topological invariant}
\pmrecord{5}{34378}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A {\em topological invariant} of a space $X$ is a property that depends only on the topology of the space, i.e. it is shared by any topological space homeomorphic to $X$.  Common examples include \PMlinkname{compactness}{Compact}, \PMlinkname{connectedness}{ConnectedSpace}, \PMlinkname{Hausdorffness}{T2Space}, Euler characteristic, \PMlinkname{orientability}{Orientation2}, \PMlinkname{dimension}{InvarianceOfDimension}, and \PMlinkescapetext{algebraic invariants} like homology, homotopy groups, and K-theory.
