...
\usepackage{pmmeta}
\pmcanonicalname{MetricSpace}
\pmcreated{2013-03-22 11:53:19}
\pmmodified{2013-03-22 11:53:19}
\pmowner{djao}{24}
\pmmodifier{djao}{24}
\pmtitle{metric space}
\pmrecord{15}{30498}
\pmprivacy{1}
\pmauthor{djao}{24}
\pmtype{Definition}
...
\pmdefines{distance metric}
\pmdefines{metric}
\pmdefines{distance}
\pmdefines{metric topology}
\pmdefines{open ball}
\pmdefines{closed ball}
