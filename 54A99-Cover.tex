...
\usepackage{pmmeta}
\pmcanonicalname{Cover}
\pmcreated{2013-03-22 12:06:31}
\pmmodified{2013-03-22 12:06:31}
\pmowner{mps}{409}
\pmmodifier{mps}{409}
\pmtitle{cover}
\pmrecord{19}{31224}
...
\pmrelated{Compact}
\pmrelated{VarepsilonNet}
\pmrelated{Site}
\pmrelated{CoveringSpace}
\pmrelated{CompactMetricSpacesAreSecondCountable}
\pmdefines{open cover}
\pmdefines{subcover}
\pmdefines{refinement}
\pmdefines{finite cover}
\pmdefines{countable cover}
\pmdefines{uncountable cover}
\pmdefines{open subcover}
\pmdefines{open refinement}
\pmdefines{cover refinement}
