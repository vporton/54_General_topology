...
\usepackage{pmmeta}
\pmcanonicalname{PointedTopologicalSpace}
\pmcreated{2013-03-22 14:01:15}
\pmmodified{2013-03-22 14:01:15}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{pointed topological space}
\pmrecord{7}{34965}
\pmprivacy{1}
...
\pmsynonym{based topological space}{PointedTopologicalSpace}
...
%% \include{argawarga}
\begin{document}
{\bf Definition} Suppose $X$ is a non-empty topological space and $x_0$ is an 
element of $X$. Then the pair $(X,x_0)$ is called a 
\emph{pointed topological space}, or a \emph{based topological space}. 
